  ...
  it('should login a registered user', (done) => {
    chai.request(app)
      ...
      .send({
        email: 'nonsoamadi@aol.com',
        password: 'password',
        token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwiZW1haWwiOiJraW1rQGdtYWlsLmNvbSIsImlhdCI6MTYyMDExODI1Mn0.Nym87Jw9mNMgOJ28_8a76NHVRIGWQ_iavtyOZRK5Ryg'
      })
      .end((err, res) => {
